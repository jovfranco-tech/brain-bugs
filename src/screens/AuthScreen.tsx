    ...
    <div className="flex flex-col h-full overflow-y-auto no-scrollbar"
      ...
      <div className="flex flex-col items-center pt-12 pb-6 px-6">
        ...
        <p className="mt-1 text-sm text-ink/60 font-semibold" style={{ fontFamily: '"Nunito", system-ui' }}>
          {isLogin ? 'Sign in to continue the adventure' : 'Parents sign up — kids get to play!'}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 px-6 flex flex-col gap-4">
        {!isLogin && (
          <div>
            <label className="block text-xs font-bold text-ink/60 uppercase tracking-wide mb-2 ml-1"
              style={{ fontFamily: '"Nunito", system-ui' }}>Your Name</label>
            <input
              type="text"
              value={displayName}
        ...
        <div>
          <label className="block text-xs font-bold text-ink/60 uppercase tracking-wide mb-2 ml-1"
            style={{ fontFamily: '"Nunito", system-ui' }}>Email</label>
          <input
            type="email"
            value={email}
        ...
        <div>
          <label className="block text-xs font-bold text-ink/60 uppercase tracking-wide mb-2 ml-1"
            style={{ fontFamily: '"Nunito", system-ui' }}>Password</label>
          <input
            type="password"
            value={password}
